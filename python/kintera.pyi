...
def molar_mass(composition: Composition) -> float: ...
def molar_masses(
    elements: List[str], element_matrix: List[List[float]]
) -> List[float]: ...
def molar_masses_from_yaml(filename: str) -> List[float]: ...
def nasa9_gibbs_rt(temp: torch.Tensor, species: List[str]) -> torch.Tensor: ...
...
class EquilibriumOptions:
    def __init__(self) -> None: ...
    @staticmethod
    def from_yaml(filename: str, verbose: bool = False) -> EquilibriumOptions: ...
    def components(self, value: List[str] = ...) -> Any: ...
    def phases(self, value: List[str] = ...) -> Any: ...
    def reactions(self, value: List[str] = ...) -> Any: ...
    def phase_ids(self, value: List[int] = ...) -> Any: ...
    def gas_phase(self, value: int = ...) -> Any: ...
    def standard_pressure(self, value: float = ...) -> Any: ...
    def max_iter(self, value: int = ...) -> Any: ...
    def ftol(self, value: float = ...) -> Any: ...
    def mole_floor(self, value: float = ...) -> Any: ...
    def validate(self) -> None: ...

class EquilibriumTP:
    options: EquilibriumOptions
    def __init__(self, options: EquilibriumOptions) -> None: ...
    def forward(
        self,
        temp: torch.Tensor,
        pres: torch.Tensor,
