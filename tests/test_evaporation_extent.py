"""Evaporation with two gaseous products (ISSUES K12).
...
concentration unit too many. Derivation and design:
AI-canoe/doc/EVAPORATION_MULTIPRODUCT_TECH_REPORT.html.
