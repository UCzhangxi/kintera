"""S100 gate: a condensate whose internal energy exceeds its vapour's must be reported.
...
absorbs energy, which is what every seam-harness card did (ISSUES S100).
